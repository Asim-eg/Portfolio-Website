      ...
      >
        ...
        <div className='w-[500px] h-full flex flex-row items-center justify-between md:mr-20'>
          <div className='w-full h-auto flex items-center justify-between border border-[#7042f861] bg-[#0300145e] mr-[15px] px-[20px] py-[10px] rounded-full'>
            <a className='cursor-pointer text-gray-300' href='#about-me'>About me</a>
            <a className='cursor-pointer text-gray-300' href='#skills'>Skills</a>
            <a className='cursor-pointer text-gray-300' href='#projects'>Projects</a>
          </div>
        </div>
